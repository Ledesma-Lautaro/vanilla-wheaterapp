...
searchField.addEventListener("input", function () {
  ...
  if (searchField.value) {
    // Itera sobre cada elemento de searchResult y remuévelos uno por uno
  ...
  if (searchField.value) {
    searchTimeout = setTimeout(() => {
      fetchData(url.geo(searchField.value), function (locations) {
        ...
        const searchList = searchResult[0].querySelector("[data-search-list]"); // Selecciona el primer elemento
        const items = [];
        ...
        fetchData(url.forecast(lat,lon), function(forecast){
          ...
          for(const [index,data] of forecastList.entries()){
            ...
            tempLi.innerHTML = `
              ...
              <div class="card card-sm slider-card">
                ...
                <img src="./assets/images/weather_icons/${icon}.png" alt="${description}"
                  loading="lazy" width="48" height="48" class="weather-icon" title="${description}">
            ...
            <div class="card card-sm slider-card">
              ...
              loading="lazy" width="48" height="48" class="weather-icon"
          ...
          forecastSection.innerHTML = `
          <h2 class="class-title" id="forecast-label">5 days forecast</h2>
          ...
          for(let i = 7, len = forecastList.length; i < len; i += 8){
            ...
            <div class="icon-wrapper">
              ...
              />
              <span class="span">
                <p class="title-2"><sub>Max</sub> ${parseInt(temp_max)}&deg;<sup>c</sup></p>
              </span>
            </div>
